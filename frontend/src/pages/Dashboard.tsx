...
const Dashboard: React.FC = () => {
      ...
      try {
        ...
        setOpeningsData({
          eventImages: Array.isArray(data?.eventImages)
            ...
            : [],
          jobOpenings: Array.isArray(data?.jobOpenings) ? data.jobOpenings : [],
        });
      } catch (err) {
  ...
  useEffect(() => {
    ...
    const id = setInterval(() => {
      setCurrentIndex((prev) => (prev + 1) % openingsData.eventImages.length);
    }, 5000);
    ...
    <Box sx={{ p: 2, height: "calc(100vh - 80px)", overflowY: "auto" }}>
      ...
      <Grid container spacing={2}>
        <Grid item xs={12} md={4}>
          <Card
            sx={{ borderRadius: 3, mb: 2, height: 325, position: "relative" }}
          >
          ...
          <Card sx={{ borderRadius: 3, height: 250, position: "relative" }}>
            <CardContent sx={{ height: "100%", pb: 7 }}>
              <Box sx={{ display: "flex", alignItems: "center", mb: 1 }}>
              ...
              >
                ...
                <IconButton
                  disabled={
                    jobStart + ITEMS_PER_PAGE >= openingsData.jobOpenings.length
                  }
