...
const CreateProject: React.FC<CreateProjectProps> = ({ onValidityChange, onSave }) => {
  return (
    <Formik
          ...
          <Box sx={{ display: "flex", flexWrap: "wrap", gap: 2 }}>
            <Box sx={{ flex: "1 1 100%" }}>
              <Typography sx={{ fontSize: 13, mb: 0.5 }}>
                Project Name<span style={{ color: "black", fontWeight: "bold" }}>*</span>
              </Typography>
              <Divider />
              <Field
                as={TextField}
            ...
            <Box sx={{ flex: "1 1 48%" }}>
              <Typography sx={{ fontSize: 13, mb: 0.5 }}>
                Jira Code<span style={{ color: "black", fontWeight: "bold" }}>*</span>
              </Typography>
              <Field
                as={TextField}
                fullWidth
            ...
            <Box sx={{ flex: "1 1 48%" }}>
              <Typography sx={{ fontSize: 13, mb: 0.5 }}>
                Status<span style={{ color: "black", fontWeight: "bold" }}>*</span>
              </Typography>
              <Field
                as={TextField}
                fullWidth
