...
import type { JobOpening } from "../common/types";
...
const EditJobDialog: React.FC<EditJobDialogProps> = ({
  ...
  const hasChanges =
    originalJob && JSON.stringify(editJob) !== JSON.stringify(originalJob);
      ...
      <DialogActions sx={{ justifyContent: "flex-end", px: 3, pb: 3 }}>
        ...
        <Button
          ...
          sx={{
            ...
            px: 4,
            textTransform: "none",
            background: isFormValid && hasChanges ? primaryColor : "#d3d3d3",
            color: "#fff",
          }}
        >
          Save Changes
